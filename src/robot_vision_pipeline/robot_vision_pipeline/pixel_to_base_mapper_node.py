...
Publishes:
  ...
  /vision/box              → robot_vision_pipeline/Box     (Pose + size)
...
from robot_vision_pipeline.depth_utils import bbox_clip_to_image, robust_center_depth
from robot_vision_pipeline.msg import BoxDetection, Box
